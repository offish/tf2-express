...
# from express.utils import get_config, sku_to_item_data
...
#     assert db.get_price("30469;1", "buy") == (0, 0.11)
...
#     assert db.get_price("30469;1", "sell") == (0, 0.0)
#     assert db.get_price("5002;6", "buy") == (0, 1.0)
#     assert db.get_price("5002;6", "sell") == (0, 1.0)
